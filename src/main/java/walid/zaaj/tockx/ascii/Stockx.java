package walid.zaaj.tockx.ascii;
import java.util.List;

import walid.zaaj.tockx.ascii.criteria.AndCriteria;
import walid.zaaj.tockx.ascii.criteria.Asks;
import walid.zaaj.tockx.ascii.criteria.Bids;
import walid.zaaj.tockx.ascii.criteria.Criteria;
import walid.zaaj.tockx.ascii.criteria.LastSale;
import walid.zaaj.tockx.ascii.criteria.Max;
import walid.zaaj.tockx.ascii.criteria.MaxBid;
import walid.zaaj.tockx.ascii.criteria.Min;
import walid.zaaj.tockx.ascii.criteria.MinAsk;
import walid.zaaj.tockx.ascii.criteria.Sales;
import walid.zaaj.tockx.ascii.criteria.Size;
import walid.zaaj.tockx.ascii.item.Ask;
import walid.zaaj.tockx.ascii.item.Bid;
import walid.zaaj.tockx.ascii.item.Item;
import walid.zaaj.tockx.ascii.item.Offer;
import walid.zaaj.tockx.ascii.item.Sale;
import walid.zaaj.tockx.ascii.item.Sneaker;
